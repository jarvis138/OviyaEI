...
class RealTimeConversation:
    ...
    def __init__(
        self,
        ollama_url: str = "https://prime-show-visit-lock.trycloudflare.com/api/generate",
        csm_url: str = "https://astronomy-initiative-paso-cream.trycloudflare.com/generate"  # Update after creating tunnel
    ):
        print("=" * 60)
